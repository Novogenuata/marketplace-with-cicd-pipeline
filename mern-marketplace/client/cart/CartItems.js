...
export default function CartItems (props) {
  ...
  const getTotal = () => {
    const subtotal = cartItems.reduce((a, b) => a + b.quantity * b.product.price, 0);
    return subtotal + Number(tip);
  }
...
const openCheckout = () => {
  ...
  localStorage.setItem('checkoutTip', tip.toString())

  props.setCheckout(true);
  props.setCheckoutDetails({
